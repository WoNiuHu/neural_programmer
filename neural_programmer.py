...
tf.flags.DEFINE_string("output_dir", "../model/",
                       """output_dir""")
tf.flags.DEFINE_string("data_dir", "/Users/wufan/Desktop/lab/tensorflow/neural_programmer/data/",
                       """data_dir""")
...
#前面往命令行输入了一大堆参数，通过这个命令把这些都取出来，放在一个类似字典的东西里
#取的时候用FLAGS.变量名 就可以了
...
if __name__ == "__main__":#不是主文件就不调用main
